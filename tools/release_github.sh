...
drop_stale_archive "$OUT/News-Insight-Web-v$VERSION.zip"
( cd build/web && zip -qr "$OUT/News-Insight-Web-v$VERSION.zip" . )
verify_artifact "$OUT/News-Insight-Web-v$VERSION.zip" "main.dart.js" "the Web zip"
...
drop_stale_archive "$OUT/News-Insight-Android-v$VERSION.apk"
cp "$APK" "$OUT/News-Insight-Android-v$VERSION.apk"
APK_OUT="$OUT/News-Insight-Android-v$VERSION.apk"
...
drop_stale_archive "$OUT/News-Insight-iOS-v$VERSION.zip"
( cd "$(dirname "$IOS_APP")" && zip -qry "$OUT/News-Insight-iOS-v$VERSION.zip" "$(basename "$IOS_APP")" )
# iOS frameworks are flat — no Versions/ — so here App IS the binary.
verify_artifact "$OUT/News-Insight-iOS-v$VERSION.zip" \
...
for f in News-Insight-Android-v$VERSION.apk News-Insight-iOS-v$VERSION.zip \
         News-Insight-macOS-v$VERSION.zip News-Insight-Web-v$VERSION.zip; do
...
gh release create "$TAG" \
  ...
  "$OUT/News-Insight-Android-v$VERSION.apk" \
  "$OUT/News-Insight-iOS-v$VERSION.zip" \
  "$OUT/News-Insight-macOS-v$VERSION.zip" \
  "$OUT/News-Insight-Web-v$VERSION.zip"
